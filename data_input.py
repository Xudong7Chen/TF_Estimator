...
def get_data(name, batch_size=1, data_shape=16, train=True):
    def parse_function(example_proto):
        ...
        parse_example['label'] = tf.one_hot(parse_example['label'], 2, 1, 0)
        parse_example['label'] = tf.reshape(parse_example['label'], (2,))
    ...
    return next_element, next_element.pop('label')
